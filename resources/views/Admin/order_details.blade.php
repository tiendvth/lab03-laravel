...
@section('title_page','Order Details || admin')
@section('header_page','Order Details')
@section('main')
    <section class="panel">
        <div class="panel-body">
            ...
            <table class="table table-bordered table-striped mb-none" id="datatable-editable">
                ...
                <tr>
                    ...
                    <th class="table_item ">Order Id</th>
                    <th class="table_item ">Quantity</th>
                    <th class="table_item ">Unit price</th>
                ...
                @for($i = 0 ; $i < 10 ; $i++)
                    <tr class="gradeX">
                        ...
                        <td class="table_item">ao dai</td>
                        <td class="table_item">XXL</td>
                        <td class="table_item">
                            <div style="height: 25px;width: 70%;background: #c82333;margin: auto"></div>
                        </td>
                        <td class="table_item">#o{{$i+1}}</td>
                        <td class="table_item">1{{$i}}</td>
                        <td class="table_item">100{{$i}}$</td>
                        @if($i % 2 == 0)
        ...
        <input type="hidden" id="per_page_code" value="order_details">
    </section>
@endsection
