...
@section('main')
                            ...
                            <div class="chart-data-selector" id="salesSelectorWrapper">
                                ...
                                <div id="salesSelectorItems" class="chart-data-selector-items mt-sm">
                                    ...
                                    <script>
                                        ...
                                        // See: /libs/assets/javascripts/dashboard/examples.dashboard.js for more settings.
    ...
    <div class="row">
                        ...
                        <header class="panel-heading bg-primary">
                            ...
                            <div class="widget-profile-info">
                                <div class="profile-picture">
                                    <img src="/libs/assets/images/!logged-user.jpg">
                                </div>
                                        ...
                                        <ul class="simple-user-list mb-xlg">
                                            <li>
                                                <figure class="image rounded">
                                                    <img src="/libs/assets/images/!sample-user.jpg" alt="Joseph Doe Junior" class="img-circle">
                                                </figure>
                                            ...
                                            <li>
                                                <figure class="image rounded">
                                                    <img src="/libs/assets/images/!sample-user.jpg" alt="Joseph Junior" class="img-circle">
                                                </figure>
                                            ...
                                            <li>
                                                <figure class="image rounded">
                                                    <img src="/libs/assets/images/!sample-user.jpg" alt="Joe Junior" class="img-circle">
                                                </figure>
            ...
            <section class="panel">
                ...
                <div class="panel-footer">
                    <div class="input-group input-search">
                        <input type="text" class="form-control" name="q" id="qd" placeholder="Search...">
                                ...
                                <li>
                                    <div class="tm-box">
                                        ...
                                        <div class="thumbnail-gallery">
                                            <a class="img-thumbnail lightbox" href="/libs/assets/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
                                                <img class="img-responsive" width="215" src="/libs/assets/images/projects/project-4.jpg">
                                                <span class="zoom">
        ...
        <input type="hidden" id="per_page_code" value="dashboard">
    </div>
@endsection
